      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            pp = 'https://imgur.com/a/5Zobdkd.jpeg' // Assign default image URL
            ppgp = 'https://imgur.com/a/5Zobdkd.jpeg' // Assign default image URL
          } finally {
            ...
            let welcomeApiUrl = `https://imgur.com/a/5Zobdkd.jpeg${encodeURIComponent(
              ...
              'https://imgur.com/a/5Zobdkd.jpeg'
            )}`
      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            let leaveApiUrl = `https://imgur.com/a/5Zobdkd.jpeg${encodeURIComponent(
              await this.getName(user)
            )}&guildName=${encodeURIComponent(await this.getName(id))}&guildIcon=${encodeURIComponent(
              ppgp
            )}&memberCount=${encodeURIComponent(
...
global.dfail = (type, m, conn) => {
  const userTag = `👋 Hello *@${m.sender.split('@')[0]}*, `
  const emoji = {
    general: '⚙️',
    owner: '👑',
    moderator: '🛡️',
  ...
  const msg = {
    ...
    ${userTag} This command can only be used by *𝑫𝑨𝑵𝑵𝒀_𝑻𝑬𝑪𝑯™*!`,
